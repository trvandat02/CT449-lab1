...
exports.create = async (req, res, next) => {
    ...
    try {
        ...
        //return res.send({ message: "Contact was created successfully"});
    } catch (error) {
        return next (
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, `Error updating contact with id=${req.params.id} `+error));
    }
};
...
exports.findAllFavorite = async (_req, res, next) => {
    try {
        ...
        return next (
            new ApiError(500, "An Error occurred while retieving favorite contact")
        );
    }
};